...
This document provides comprehensive guidance for GitHub Copilot coding agents working on the **kataribe** repository.
...
The project uses **esbuild** for fast bundling and **TypeScript compiler** for type declarations:
...
- **`src/utils.ts`**: Utility functions (ID generation, middleware execution, logging)
...
- Publish step scaffolded (commented out)
